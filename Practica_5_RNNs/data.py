...
class TranslationDataset(Dataset):
    download_url_prefix = 'https://git.hcics.simtech.uni-stuttgart.de/public-projects/MPL_course_data/raw/branch/main'
    ...
    def _preprocess(self, lang1='eng', lang2='fra'):
        reverse = True
        path = self._folder  # <-- use the folder where files are located
        ...
        pickle.dump(input_lang, open(os.path.join(path, self.source_lang_file), "wb"))
        pickle.dump(output_lang, open(os.path.join(path, self.target_lang_file), "wb"))
        pickle.dump(pairs, open(os.path.join(path, self.pairs_file), "wb"))
        pickle.dump(train_pairs, open(os.path.join(path, self.train_pairs_file), "wb"))
        pickle.dump(test_pairs, open(os.path.join(path, self.test_pairs_file), "wb"))

        self.input_lang = input_lang
        self.output_lang = output_lang
        self.pairs = train_pairs if hasattr(self, 'train') and self.train else test_pairs
